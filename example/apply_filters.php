...
$mailbox = new ImapMailbox('{imap.gmail.com:993/imap/ssl}Test Follow Up', GMAIL_EMAIL, GMAIL_PASSWORD, ATTACHMENTS_DIR, 'utf-8');
$mails = array();
...
$mailFilters->addFilter('subject',"*HasSomethingInIt*",array("do"=>"return","params"=>array("Hello World, the Subject filter was matched")));
